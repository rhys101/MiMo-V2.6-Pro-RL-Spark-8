...
def _w4a8_dynamic_materialized_enabled(
    *,
    ...
    # The materialized M1 specialization fails the clamped/negative-route
    # graph oracle for this DeepSeek-V4.1 EP8 shard on SM121. Use the
    # existing monolithic route, retaining the same quantization and clamp.
    if int(num_tokens) == 1 and (num_experts, k, n) == (48, 5120, 2304):
        return False
